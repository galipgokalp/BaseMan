...
- [Getting Started](#getting-started)
 ...
 - [Making Your App Display](#making-your-app-display)
 - [Troubleshooting](#troubleshooting)
 - [Building with AI](#building-with-ai)
 - [Next Steps](#next-steps)
- [Specification](#specification)
 - [Mini App Embed](#mini-app-embed)
 - [App Surface](#app-surface)
 - [SDK](#sdk)
 - [Manifest](#manifest)
 - [Adding Mini Apps](#adding-mini-apps)
 - [Purpose](#purpose)
 - [General Guidelines](#general-guidelines)
 - [Common LLM Pitfalls](#common-llm-pitfalls)
 - [Prerequisites](#prerequisites)
 - [Check 1: Manifest Configuration](#check-1-manifest-configuration)
 - [Post-Check Verification](#post-check-verification)
 - [Check 2: Embed Metadata](#check-2-embed-metadata)
 - [Check 3: Preview and Runtime](#check-3-preview-and-runtime)
 - [Quick Reference](#quick-reference)
 - [Related Documentation](#related-documentation)
- [Authenticating users](#authenticating-users)
 - [Quick Auth](#quick-auth)
 - [Sign In with Farcaster](#sign-in-with-farcaster)
 - [Enable seamless sign in on web](#enable-seamless-sign-in-on-web)
- [App Discovery & Search](#app-discovery-search)
 - [Making Your App Discoverable in Farcaster](#making-your-app-discoverable-in-farcaster)
 - [FAQ](#faq)
- [Migrating to a new domain](#migrating-to-a-new-domain)
 - [How domain migration works](#how-domain-migration-works)
 - [Migration steps](#migration-steps)
 - [Best practices](#best-practices)
 - [Troubleshooting](#troubleshooting)
- [FAQ: Frequently Asked Questions](#faq-frequently-asked-questions)
 - [What is the difference between a manifest and an embed?](#what-is-the-difference-between-a-manifest-and-an-embed)
 - [Do I need both a manifest and embeds?](#do-i-need-both-a-manifest-and-embeds)
 - [Are Frames v2 and Mini Apps the same thing?](#are-frames-v2-and-mini-apps-the-same-thing)
 - [Do I need paid APIs to build a Mini App?](#do-i-need-paid-apis-to-build-a-mini-app)
 - [Why isn't my app showing up in search?](#why-isnt-my-app-showing-up-in-search)
 - [Why do I see an infinite loading screen?](#why-do-i-see-an-infinite-loading-screen)
 - [How do I test my Mini App locally?](#how-do-i-test-my-mini-app-locally)
 - [My manifest isn't validating. What's wrong?](#my-manifest-isnt-validating-whats-wrong)
 - [How does app discovery and ranking work?](#how-does-app-discovery-and-ranking-work)
 - [Can I use my own authentication instead of Farcaster auth?](#can-i-use-my-own-authentication-instead-of-farcaster-auth)
 - [How do I get notifications working?](#how-do-i-get-notifications-working)
 - [What happens if users don't have Farcaster accounts?](#what-happens-if-users-dont-have-farcaster-accounts)
 - [How do I handle breaking changes?](#how-do-i-handle-breaking-changes)
- [Loading your app](#loading-your-app)
 - [Calling ready](#calling-ready)
 - [Splash Screen](#splash-screen)
 - [Previewing your app](#previewing-your-app)
- [Farcaster Mini Apps: Manifests vs Embeds Developer Guide](#farcaster-mini-apps-manifests-vs-embeds-developer-guide)
...
- [Share Extensions](#share-extensions)
 ...
 - [Setting up share extensions](#setting-up-share-extensions)
 - [Receiving shared casts](#receiving-shared-casts)
 - [Implementation example](#implementation-example)
 - [Real-world example: Degen Stats](#real-world-example-degen-stats)
 - [Best practices](#best-practices)
 - [Testing share extensions](#testing-share-extensions)
 - [Next steps](#next-steps)
- [Sharing your app](#sharing-your-app)
 - [Sharing a page in your app](#sharing-a-page-in-your-app)
 - [Properties](#properties)
 - [Example](#example)
 - [Generating dynamic images](#generating-dynamic-images)
...
- [Interacting with Solana wallets](#interacting-with-solana-wallets)
 - [Getting Started](#getting-started)
 - [Low-level Solana provider](#low-level-solana-provider)
 - [Using Wallet Standard directly](#using-wallet-standard-directly)
 - [Demo app](#demo-app)
 - [Troubleshooting](#troubleshooting)
- [Universal Links](#universal-links)
 - [Where to find the Universal Link](#where-to-find-the-universal-link)
 - [How to control what is displayed when I share a Universal Link](#how-to-control-what-is-displayed-when-i-share-a-universal-link)
 - [How Universal Link sub-paths and query params work](#how-universal-link-sub-paths-and-query-params-work)
 - [FAQ](#faq)
- [Interacting with Ethereum wallets](#interacting-with-ethereum-wallets)
 - [Getting Started](#getting-started)
 - [Additional Features](#additional-features)
 - [Troubleshooting](#troubleshooting)
 - [Using Neynar to build mini apps](#using-neynar-to-build-mini-apps)
- [Back Navigation](#back-navigation)
 - [Usage](#usage)
 - [Back control](#back-control)
 - [Web Navigation integration](#web-navigation-integration)
 - [Properties](#properties)
 - [Methods](#methods)
 - [Events](#events)
 - [Availability](#availability)
 - [Example: Web Navigation](#example-web-navigation)
...
- [Context](#context)
 - [Properties](#properties)
- [Detecting chains & capabilities](#detecting-chains-capabilities)
 - [Declaring requirements in your manifest](#declaring-requirements-in-your-manifest)
...
- [ready](#ready)
 ...
 - [Parameters](#parameters)
 - [Return Value](#return-value)
- [requestCameraAndMicrophoneAccess](#requestcameraandmicrophoneaccess)
 - [Platform Support](#platform-support)
 - [Usage](#usage)
 - [Return Value](#return-value)
 - [Feature Detection](#feature-detection)
 - [Permissions](#permissions)
 - [Example: Video Recording](#example-video-recording)
- [sendToken](#sendtoken)
 - [Usage](#usage)
 - [Parameters](#parameters)
 - [Return Value](#return-value)
- [signIn](#signin)
 ...
 - [Return Value](#return-value)
 - [Errors](#errors)
- [signManifest (Experimental)](#signmanifest-experimental)
 - [Usage](#usage)
 - [Parameters](#parameters)
 - [Return Value](#return-value)
 - [Errors](#errors)
...
- [quickAuth.fetch](#quickauthfetch)
 ...
 - [Parameters](#parameters)
 - [Return Value](#return-value)
- [quickAuth.getToken](#quickauthgettoken)
 - [Usage](#usage)
 - [Parameters](#parameters)
 - [Return Value](#return-value)
- [Quick Auth](#quick-auth)
 ...
 - [Quick Auth vs Sign In with Farcaster](#quick-auth-vs-sign-in-with-farcaster)
 - [Functions](#functions)
 - [Properties](#properties)
- [quickAuth.token](#quickauthtoken)
 - [Usage](#usage)
- [Temel Kavramlar](#temel-kavramlar)
- [Embed Gereksinimleri](#embed-gereksinimleri)
- [Notlar](#notlar)
<!-- /TOC -->
...
Command: curl -s https://{domain}/{path} | grep -E 'fc:miniapp|fc:frame'
Expected Output: <meta name="fc:miniapp" content='{"version":"1","imageUrl":"...","button":{...}}' />
...
URL Format: https://farcaster.xyz/~/developers/mini-apps/preview?url={encoded-mini-app-url}
...
Re-verify the manifest is deployed: curl -s https://{domain}/.well-known/farcaster.json | jq .
...
* [App Keys](https://docs.farcaster.xyz/reference/warpcast/api#get-creator-reward-winners)
...
* **Node.js 22.11.0 or higher** (LTS version recommended)
 * Check your version:`node --version`* Download from [nodejs.org](https://nodejs.org/)
* A package manager (npm, pnpm, or yarn)
...
the bottom of your HTML file with the following content.```html
<script type="module">
 import { sdk } from 'https://esm.sh/@farcaster/miniapp-sdk
</script>
```### Making Your App Display

After your app loads, you must call`sdk.actions.ready`to hide the splash screen and display your content:```javascript
import { sdk } from '@farcaster/miniapp-sdk'
...
* `npm ERR! engine Unsupported platform`*`npm ERR! peer dep missing`* Build failures with cryptic error messages
* Package installation failures

**Solution:**

1. Check your Node.js version:```bash
 node --version
...
{
 "version": "1",
 "imageUrl": "https://example.com/opengraph-image
 "button": {
"title": "🚩 Start",
"action": {
 "type": "launch_frame",
...
integrate with their Mini App. This file is published at`/.well-known/farcaster.json`and the [Fully Qualified Domain
...
account's custody address or a valid auth address with the following payload:```json
{
 domain: string;
}
...
Example of a valid farcaster.json manifest:```json
{
 "accountAssociation": {
"header": "eyJmaWQiOjM2MjEsInR5cGUiOiJjdXN0b2R5Iiwia2V5IjoiMHgyY2Q4NWEwOTMyNjFmNTkyNzA4MDRBNkVBNjk3Q2VBNENlQkVjYWZFIn0",
"payload": "eyJkb21haW4iOiJ5b2luay5wYXJ0eSJ9",
...
*`miniapp_added`*`miniapp_removed`*`notifications_enabled`*`notifications_disabled`The body looks like this:
...
* Open`targetUrl`* Set the context to the notification, see`NotificationLaunchContext`##### Idempotency
...
* 1 notification per 30 seconds per`token`* 100 notifications per day per`token`##### Displaying notifications
...
* **DO NOT** reference Frames v1 syntax or fields like`fc:frame:image`, `fc:frame:button`* **DO NOT** invent manifest fields not in the official schema
* **DO NOT** mix Frame and Mini App terminology (Mini Apps are not Frames)
* **DO NOT** use outdated examples from before 2024
* **DO NOT** use`fc:frame`meta tag for new implementations. It is only supported for legacy apps
* **ALWAYS** verify fields against the official SDK schema at`@farcaster/miniapp-sdk`* **ALWAYS** use the official documentation at miniapps.farcaster.xyz
* **ALWAYS** check that examples use`miniapp`or`frame`(not`frames`) in manifest
* **ALWAYS** use `fc:miniapp`meta tag for new Mini Apps (not`fc:frame`)
...
* Official Mini Apps documentation (this site)
* The @farcaster/miniapp-sdk package
* Examples that use `"version": "1"`not`"version": "next"`### Prerequisites
 ...
 **Decision Flow:**```Is hosting available?
 ...
 └─ Create file at /.well-known/farcaster.json```**For Vercel redirect:**```json
 {
 "redirects": [
 {
 "source": "/.well-known/farcaster.json",
 "destination": "https://docs.farcaster.xyz/reference/warpcast/api#get-hosted-manifest
 "permanent": false
 }
 ]
 }
...
1. Decode the base64url`payload`from`accountAssociation.payload`2. Extract the`domain`field
...
**For Next.js Applications:**```typescript
// app/layout.tsx or pages with generateMetadata
import { Metadata } from 'next'
...
**URL Format:**```https://farcaster.xyz/~/developers/mini-apps/preview?url={encoded-mini-app-url}```**Example:**```bash
# Encode your URL
encoded_url=$(python3 -c "import urllib.parse; print(urllib.parse.quote('https://example.com/page
echo "https://farcaster.xyz/~/developers/mini-apps/preview?url=$encoded_url
````
...
If you are using Quick Auth no action is needed. If you are using`signIn`directly you will need to make a couple changes to support signing in with Auth
Addresses:
...
Farcaster client developers can find more information [Public Auth Address Implementation Guide 1fc6a6c0c10180a9b2a7f24c71143eae](https://www.notion.so/warpcast/Public-Auth-Address-Implementation-Guide-1fc6a6c0c10180a9b2a7f24c71143eae)
...
If you verify sign in messages yourself, update the`@farcaster/auth-client`package to version`0.7.0`or later. Calling`verifySignInMessage`will now verify
...
* ✅`app.new-domain.com`* ✅`new-domain.com`* ❌`https://new-domain.com`* ❌`new-domain.com:3000`* ❌`new-domain.com/app`:::
...
Make sure you're calling`sdk.actions.ready`after your app is fully loaded:```javascript
import { sdk } from '@farcaster/miniapp-sdk'
...
* [ ] `fc:miniapp`meta tag in HTML`<head>`* [ ] Version, image URL, and button configuration
...
#### Add your webhook URL in`farcaster.json`If you haven't already, follow the [Publishing your app](/docs/guides/publishing) guide to host a`farcaster.json`on your app's domain.
...
notification token for the user. This token is sent to`webhookUrl`defined in your`farcaster.json`along with a`url`that the app should call to send a notification.
...
For example, if you want to send a daily notification to users you could use`daily-reminder-05-06-2024`as your`notificationId`. Now you can safely retry
...
* 1 notification per 30 seconds per `token`* 100 notifications per day per`token`::::
...
<details>
 ...
 server to redirect requests to`https://docs.farcaster.xyz/reference/warpcast/api#get-hosted-manifest`once and
...
```</details>
 ...
 <details>
<summary>Redirects in Express</summary>```ts
const express = require('express')
const app = express

app.get('/.well-known/farcaster.json', (req, res) => {
 res.redirect(307, 'https://docs.farcaster.xyz/reference/warpcast/api#get-hosted-manifest
})
```</details>

 <details>
<summary>Redirects in Hono</summary>```ts
import { Hono } from 'hono'
const app = new Hono

app.get('/.well-known/farcaster.json', (c) => {
 return c.redirect('https://docs.farcaster.xyz/reference/warpcast/api#get-hosted-manifest 307)
})
```</details>

 <details>
<summary>Redirects in Remix</summary>```ts
// app/routes/.well-known/farcaster.json.tsx
import { redirect } from '@remix-run/node'

export const loader = => {
 return redirect('https://docs.farcaster.xyz/reference/warpcast/api#get-hosted-manifest 307)
}
...
Here's an example`farcaster.json`file:```json
{
 "miniapp": {
"version": "1",
"name": "Yoink!",
...
To enable your Mini App to receive shared casts, add a`castShareUrl`to your manifest:```json
{
...
Example URL:```https://your-app.com/share?castHash=0x5415e243853e&castFid=2417&viewerFid=12152```These parameters are available immediately, even during server-side rendering, allowing you to begin fetching cast data right away.

#### 2. SDK Context (Available after initialization)

Once your Mini App initializes, the SDK provides enriched cast data through the location context:```typescript
import sdk from '@farcaster/miniapp-sdk';
...
```The cast object includes:```typescript
type MiniAppCast = {
 author: {
fid: number;
username?: string;
...
Here's a complete example showing how to handle shared casts in your Mini App:```typescript
...
sharable specifying the embed metadata:```html
...
####`button.title`This text will be rendered in the button. Use a clear call-to-action that hints
to the user what action they can take in your app.

####`button.action.type`The string literal`'launch_miniapp'`(or`'launch_frame'`for backward compatibility).
...
2. Sets up Wallet Adapter to automatically select the Farcaster wallet.```tsx
import * as React from 'react';
import { FarcasterSolanaProvider } from '@farcaster/mini-app-solana';
import { useWallet } from '@solana/wallet-adapter-react';

const solanaEndpoint = 'https://www.helius.dev/docs/rpc/overview#getting-your-rpc-url';
...
This provider is modeled after `window.phantom.solana`and its full API can be found [Solana Ts](https://github.com/farcasterxyz/miniapps/blob/main/packages/miniapp-core/src/solana.ts)
...
In order to do so, it's important that you still import our package in your app entry:```tsx
...
To see how a working Mini App uses a Solana wallet, check out our demo Mini App [Demo Tsx](https://github.com/farcasterxyz/frames-v2-demo/blob/main/src/components/Demo.tsx)
...
and web sites. The URL format is as follows:`https://farcaster.xyz/miniapps/<app-id>/<app-slug>(/<sub-path>)(?<query-params>)`* The`<app-id>`is a unique identifier assigned to the Mini App when it is [published](/docs/guides/publishing).
...
Add the Mini App connector to your Wagmi config:```ts
...
for a connection and prompt them to connect if they aren't already connected:```tsx
...
With Wagmi's `useSendCalls`hook, sending multiple transactions as a batch is simple:```tsx
...
```##### Example: Token Approval and Swap```tsx
import { useSendCalls } from 'wagmi'
...
* **Mini app starter kit** - Type`npx @neynar/create-farcaster-mini-app@latest`in your terminal to get started. See [Create Farcaster Miniapp In 60s](https://docs.neynar.com/docs/create-farcaster-miniapp-in-60s) for more information.
* **Send notifications to mini app users** - Notification server to send notifications over API or from portal. Includes batching, targeting, etc. Read more [Send Notifications To Mini App Users](https://docs.neynar.com/docs/send-notifications-to-mini-app-users#frame-manifest-caching)
* **Convert existing web app to mini app** - Follow guide [Convert Web App To Mini App](https://docs.neynar.com/docs/convert-web-app-to-mini-app)
* **Fetch mini apps by categories** - See API [Fetch Frame Catalog](https://docs.neynar.com/reference/fetch-frame-catalog)
* **Fetch relevant mini apps for a given user** - See API [Fetch Frame Relevant](https://docs.neynar.com/reference/fetch-frame-relevant)
* **Search mini app namespace** - See API [Search Frames](https://docs.neynar.com/reference/search-frames)
* **Crawl mini app metadata** - See API [Fetch Frame Meta Tags From Url](https://docs.neynar.com/reference/fetch-frame-meta-tags-from-url)

#### Use with AI

Set up Neynar with MCP server and llms.txt - See instructions [Neynar Farcaster With Cursor](https://docs.neynar.com/docs/neynar-farcaster-with-cursor/docs/neynar-farcaster-with-cursor)
...
integrate in one line with:```ts
await sdk.back.enableWebNavigation;
```That's it! When there is a page to go back to a [back control](#back-control) will be made
available to the user.

Otherwise, you can set a custom back handler and show the back control:```ts
sdk.back.onback = => {
...
####`enableWebNavigation`Enables automatic integration with the browser's navigation system. This will:
...
```ts
await sdk.back.enableWebNavigation;
```####`disableWebNavigation`Disables web navigation integration.```ts
await sdk.back.disableWebNavigation;
```### Properties

####`enabled`* **Type**:`boolean`* **Description**: Whether back navigation is currently enabled

####`onback`* **Type**:` => unknown`* **Description**: Function to call when a back event is triggered. You don't need to
 set this when using`enableWebNavigation`.

### Methods

#### `show`Makes the back button visible.```ts
await sdk.back.show;
```####`hide`Hides the back button.```ts
await sdk.back.hide;
```### Events
...
You can check whether the Farcaster client rendering your app supports a back control:```ts twoslash
import { sdk } from '@farcaster/miniapp-sdk'
...
####`location`Contains information about the context from which the Mini App was launched.```ts
...
Indicates that the Mini App was launched from a cast (where it is an embed).```ts
...
Indicates that the Mini App was launched when a user shared a cast to your app (similar to sharing content to an app on mobile platforms).```ts
> sdk.context.location
{
 type: "cast_share",
 cast: {
...
Indicates that the Mini App was launched from a notification triggered by the frame.```ts
> sdk.context.location
{
 type: "notification",
 notification: {
...
Indicates that the Mini App was launched directly by the client app outside of a context, e.g. via some type of catalog or a notification triggered by the client.```ts
> sdk.context.location
{
 type: "launcher"
}
...
Indicates that the Mini App was launched from another Mini App using the`openMiniApp`action. This enables app-to-app navigation and referral tracking.```ts
> sdk.context.location
{
 type: "open_miniapp",
...
#### `user`Details about the calling user which can be used to customize the interface. This should be considered untrusted since it is passed in by the application, and there is no guarantee that it was authorized by the user.```ts
...
* `notificationDetails`: in case the user has enabled notifications, includes the `url`and`token`for sending notifications```ts
...
A basic usage would to wrap your view in a container that adds margin:```<div style={{
 ...
 ...your app view
</div>```However, you may want to set these insets on specific elements: for example if
...
Optional object that indicates which features are available and their current state in the client.```ts
...
You can use the`features`object to conditionally enable functionality based on platform support:```ts
...
#### `requiredChains``miniapp.requiredChains`is an optional [manifest](/docs/guides/publishing#host-a-manifest-file) property that contains an array of [CAIP-2](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) identifiers. If the host does not support all of the chains declared here, it will know not to try rendering your Mini App.

Note that only the chains listed in`chainList`[Manifest Ts](https://github.com/farcasterxyz/miniapps/blob/main/packages/miniapp-core/src/schemas/manifest.ts) are supported. If your manifest omits`requiredChains`, then the mini app host will assume that no chains are required.

#### `requiredCapabilities``miniapp.requiredCapabilities`is an optional [manifest](/docs/guides/publishing#host-a-manifest-file) property that contains an array of paths to SDK methods, such as`wallet.getEthereumProvider`or`actions.composeCast`. If the host does not support all of the capabilities declared here, it will know not to try rendering your Mini App.

The full list of supported SDK methods can be found in `miniAppHostCapabilityList`[Types Ts](https://github.com/farcasterxyz/miniapps/blob/main/packages/miniapp-core/src/types.ts) If your manifest omits`requiredCapabilities`, then the mini app host will assume that no capabilities are required.
...
#### `getChains`This SDK method returns a list of supported blockchains as an array of [CAIP-2](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) identifiers.

####`getCapabilities`This SDK method returns a list of supported SDK methods as an array of paths to those SDK methods. The full list of supported SDK methods can be found in`miniAppHostCapabilityList`[Types Ts](https://github.com/farcasterxyz/miniapps/blob/main/packages/miniapp-core/src/types.ts)
...
* **Type:**`'light' | 'medium' | 'heavy' | 'soft' | 'rigid'`The intensity and style of the impact feedback.
...
* **Type:**`'success' | 'warning' | 'error'`The type of notification feedback.
...
Haptic feedback availability depends on the client device and platform. You can check if haptics are supported using the `getCapabilities`method:```ts twoslash
import { sdk } from '@farcaster/miniapp-sdk'
...
* **Type:**`number`* **Default:**`100`Optional timeout in milliseconds for context verification. If the context doesn't resolve within this time, the function assumes it's not in a Mini App environment.

### Return Value

* **Type:**`Promise<boolean>`Returns a promise that resolves to`true`if running in a Mini App context, or`false`otherwise.
...
Mini apps written in React can use [Wallet Adapter](https://github.com/anza-xyz/wallet-adapter) React hooks, which are sort of like Solana's equivalent of Wagmi. Wallet Adapter also exposes a more low-level interface for non-React apps.
...
The SDK exposes an [EIP-1193 Ethereum Provider](https://eips.ethereum.org/EIPS/eip-1193) at`sdk.wallet.getEthereumProvider`. You can
...
* Your app must be deployed to the same domain specified in your`farcaster.json`* For local development, use the preview tool instead of trying to add the app

### Return Value`void`### Errors

####`RejectedByUser`Thrown if a user rejects the request to add the Mini App.

####`InvalidDomainManifestJson`Thrown when an app does not have a valid`farcaster.json`or when the domain doesn't match. Common causes:
...
```### Return Value`void`import { Caption } from '../../../../components/Caption.tsx';
...
* **Type:**`string`Suggested text for the body of the cast.

Mentions can be included using the human-writeable form (e.g. @farcaster).

#### embeds (optional)

* **Type:**`[] | [string] | [string, string]`Suggested embeds. Max two.

#### parent (optional)

* **Type:**`{ type: 'cast'; hash: string }`Suggested parent of the cast.

#### close (optional)

* **Type:**`boolean`Whether the app should be closed when this action is called. If true the app
will be closed and the action will resolve with no result.

#### channelKey (optional)

* **Type:**`string`Whether the cast should be posted to a channel.

### Return Value

The cast posted by the user, or`undefined`if set to close.

**Note:** The`cast`property in the result can be`null`if the user decides not to create the cast.```ts twoslash
import { sdk } from "@farcaster/miniapp-sdk";
 ...
 * A Mini App embed URL (e.g., `https://example.com/specific-page`* A Mini App launch URL (e.g.,`https://farcaster.xyz/miniapps/[id]/[name]`)
...
Always await the`openMiniApp`call and handle potential errors:```ts
import { sdk } from '@farcaster/miniapp-sdk'
...
Create a central hub that showcases multiple Mini Apps:```ts
const miniApps = [
...
Implement referral tracking between Mini Apps:```ts
...
* **Type:**`boolean`* **Default:**`false`Disable native gestures. Use this option if your frame uses gestures
that conflict with native gestures like swipe to dismiss.

### Return Value`void`## requestCameraAndMicrophoneAccess
...
Before using this action, check if it's supported:```ts twoslash
import { sdk } from '@farcaster/miniapp-sdk'
...
### Example: Video Recording```ts twoslash
import { sdk } from '@farcaster/miniapp-sdk'
...
* **Type:**`string`A random string used to prevent replay attacks, at least 8 alphanumeric
characters.

#### acceptAuthAddress

* **Type:**`boolean`Whether an [Auth
...
The SIWF message and signature.```ts
type SignInResult = {
 signature: string;
 message: string;
}
...
####`RejectedByUser`Thrown if a user rejects the sign-in request.```ts
try {
...
####`options`* **domain** (required): The domain to sign the manifest for
...
* **signature**: The cryptographic signature```ts
{
 header: string
 payload: string
 signature: string
...
####`RejectedByUser`Thrown if a user rejects the request to sign the manifest.```ts
try {
...
```####`InvalidDomain`Thrown when the provided domain is invalid or malformed.```ts
try {
...
```####`GenericError`Thrown when manifest signing fails for various reasons including host restrictions, network issues, or other implementation-specific failures.```ts
try {
 await sdk.experimental.signManifest({ domain: 'example.com' })
} catch (error) {
...
For robust error handling, you should catch all specific error types:```ts
try {
...
* **Type:**`string`Sell token amount, as numeric string
...
* **Type:**`string`The hash of the cast to view. This should be a valid cast hash from the Farcaster protocol.
...
### Return Value`Promise<void>`- This action does not return a value. It triggers navigation to the cast view in the Farcaster client.```ts twoslash
import { sdk } from "@farcaster/miniapp-sdk";
...
* **Type:**`number`Farcaster ID of the user whose profile to view.

### Return Value`void`## viewToken
...
### Return Value`void`## quickAuth.fetch
...
* **Type:**`boolean`Acquire a new token even if one is already in memory and not expired.

#### quickAuthServerOrigin (optional)

* **Type:**`string`Use a custom Quick Auth Server. Defaults to`https://auth.farcaster.xyz`.
...
* **Type:**`number`The FID of the signed in user.

##### iss

* **Type:**`string`The Quick Auth server that verified the SIWF credential and issued the JWT.

##### aud

* **Type:**`string`The domain this token was issued to.

##### exp

* **Type:**`number`The JWT expiration time.
...
`Authorization`header:```tsx twoslash
...
First, install the Quick Auth library into your backend with:```npm install @farcaster/quick-auth```Then you can use`verifyJwt`to check the JWT and get back the token payload
which has the FID of the user as the`sub`property.

You can then look up additional information about the user.```ts
...
export default app```### Optimizing performance
...
Calling ready
Call ready when your interface is ready to be displayed: https://miniapps.farcaster.xyz/docs/sdk/actions/ready
...
You'll learn how to configure the Splash Screen in the sharing your app: https://miniapps.farcaster.xyz/docs/guides/sharing and publishing your app: https://miniapps.farcaster.xyz/docs/guides/publishing guides.
...
Open the Mini App Debug Tool: https://farcaster.xyz/~/developers/mini-apps/debug on desktop
Enter your app url
Hit Preview
You must be logged into your Warpcast account on desktop to access the Mini App Debug Tool.
...
Learn how to find the Universal Link for your apps and how they work in the Universal Links: https://miniapps.farcaster.xyz/docs/guides/urls guide.

Debugging: You can use the Mini App Embed Tool: https://farcaster.xyz/~/developers/mini-apps/embed in Warpcast to preview a embed.
...
Expose localhost
Run the following command in your terminal: cloudflared tunnel --url http://localhost:8080
Be sure to specify the correct port for your local server.
Use the provided url: cloudflared will generate a random subdomain and print it in the terminal for you to use. Any traffic to this URL will get sent to you local server.
...
Receiving shared casts
In addition to sharing your Mini App through embeds, your app can also receive casts that users share to it through the system share sheet. Learn more in the Share Extensions guide: https://miniapps.farcaster.xyz/docs/guides/share-extension
...
Getting Started
The Mini App SDK exposes an EIP-1193 Ethereum Provider API: https://eips.ethereum.org/EIPS/eip-1193 at sdk.wallet.getEthereumProvider

We recommend using Wagmi: https://wagmi.sh/ to connect to and interact with the user's wallet. This is not required but provides high-level hooks for interacting with the wallet in a type-safe way.

Setup Wagmi
Use the Getting Started guide: https://wagmi.sh/react/getting-started#manual-installation to setup Wagmi in your project.
...
Follow this guide from Wagmi: https://wagmi.sh/react/guides/send-transaction#_2-create-a-new-component on sending a transaction (note: skip step 1 since you're already connected to the user's wallet).
...
For now we'll create an empty file: touch public/.well-known/farcaster.json
...
iconUrl string	Yes	Icon image URL	Max length 1024 characters.Imagemust be 1024x1024px PNG, no alpha.
splashImageUrl	string	No	URL of image to show on loading screen.	Max length 32 characters. Must be 200x200px.
splashBackgroundColor	string	No	Hex color code to use on loading screen.	Hex color code.
...
requiredChains	array	No	CAIP-2: https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md IDs of required chains (more info)	Only chains listed in chainList here are supported
...
Verified Mini Apps are automatically eligible for Warpcast Developer Rewards: https://farcaster.xyz/~/mini-apps/rewards that are paid out weekly based on usage and onchain transactions.

Verification is done by placing a cryptographically signed message in the accountAssociation property of your farcaster.json.

You can generate a signed account association object using the Mini App Manifest Tool: https://farcaster.xyz/~/developers/new in Warpcast. Take the output from that tool and update your farcaster.json file.
...
App Discovery & Search: https://miniapps.farcaster.xyz/docs/guides/discovery

Making your Mini App discoverable is crucial for reaching users in the Farcaster ecosystem. This guide covers how to ensure your app is correctly indexed and visible in our mini apps catalogue.

Making Your App Discoverable in Farcaster
Apps appear in the main directory: https://farcaster.xyz/miniapps and search engine on Farcaster. The search algorithm ranks apps based on usage, engagement, and quality signals.
...
Migrating to a new domain: https://miniapps.farcaster.xyz/docs/guides/domain-migration
...
Migration steps:
Prepare your new domain: Set up your Mini App on the new domain with a complete manifest file at /.well-known/farcaster.json. This should include all your app configuration and an account association from the same FID to maintain ownership verification.
...
Update the old domain manifest: Add the canonicalDomain field to your manifest on the old domain, pointing to your new domain:
...
Reference: Notifications Spec: https://miniapps.farcaster.xyz/docs/specification#notifications
...
Managed - If you'd rather stay focused on your app, use Neynar: https://neynar.com/ to manage notification tokens on your behalf. Includes ways to target notifications and send without writing code:
Setup a managed notifications server with Neynar: https://docs.neynar.com/docs/send-notifications-to-mini-app-users#frame-manifest-caching
...
If you haven't already, follow the Publishing your app: https://miniapps.farcaster.xyz/docs/guides/publishing guide to host a farcaster.json on your app's domain.
...
Use the addMiniApp: https://miniapps.farcaster.xyz/docs/sdk/actions/add-miniapp action while a user is using your app to prompt them to add it:
...
If you'd rather stay focused on your app, Neynar offers a managed service to handle webhooks: https://docs.neynar.com/docs/send-notifications-to-frame-users#step-1-add-events-webhook-url-to-frame-manifest on behalf of your application.
...
For a complete example, check out the Mini App V2 Demo: https://github.com/farcasterxyz/frames-v2-demo has all of the above:
Handles webhooks: https://github.com/farcasterxyz/frames-v2-demo/blob/main/src/app/api/webhook/route.ts leveraging the @farcaster/miniapp-node: https://github.com/farcasterxyz/miniapps/tree/main/packages/miniapp-node library that makes this very easy
Saves notification tokens to Redis: https://github.com/farcasterxyz/frames-v2-demo/blob/main/src/lib/kv.ts
Sends notifications: https://github.com/farcasterxyz/frames-v2-demo/blob/main/src/lib/notifs.ts

Authenticating users: https://miniapps.farcaster.xyz/docs/guides/auth
...
Quick Auth
The easiest way to get an authenticated session for a user. Quick Auth: https://miniapps.farcaster.xyz/docs/sdk/quick-auth uses Sign in with Farcaster: https://docs.farcaster.xyz/developers/siwf/ under the hood to authenticate the user and returns a standard JWT that can be easily verified by your server and used as a session token.

Get started with Quick Auth: https://miniapps.farcaster.xyz/docs/sdk/quick-auth

Sign In with Farcaster
Alternatively, an app can use the signIn: https://miniapps.farcaster.xyz/docs/sdk/actions/sign-in to get a Sign in with Farcaster: https://docs.farcaster.xyz/developers/siwf/ authentication credential for the user.

After requesting the credential, applications must verify it on their server using verifySignInMessage: https://docs.farcaster.xyz/auth-kit/client/app/verify-sign-in-message Apps can then issue a session token like a JWT that can be used for the remainder of the session.

Enable seamless sign in on web
Farcaster recently added support for signing in via additional wallets (see the Auth Address: https://github.com/farcasterxyz/protocol/discussions/225 standard).
...
Farcaster client developers can find more information here: https://www.notion.so/native/warpcast/Public-Auth-Address-Implementation-Guide-1fc6a6c0c10180a9b2a7f24c71143eae?cookie_sync_completed=true&deepLinkOpenNewTab=true
...
Universal Links: https://miniapps.farcaster.xyz/docs/guides/urls
...
Example URL: https://your-app.com/share?castHash=0x5415e243853e&castFid=2417&viewerFid=12152
...
Next steps
Learn about SDK Context to understand all available location types: https://miniapps.farcaster.xyz/docs/sdk/context
Explore Compose Cast to let users create casts from your Mini App: https://miniapps.farcaster.xyz/docs/sdk/actions/compose-cast
Check out View Cast to navigate users to specific casts: https://miniapps.farcaster.xyz/docs/sdk/actions/view-cast

Farcaster Mini Apps: Manifests vs Embeds Developer Guide: https://miniapps.farcaster.xyz/docs/guides/manifest-vs-embed
...
SDK:
What's New: https://miniapps.farcaster.xyz/docs/sdk/changelog
...
Validate a session token:
First, install the Quick Auth library into your backend with: npm install @farcaster/quick-auth
...
To optimize performance, provide a preconnect hint to the browser in your frontend so that it can preemptively initiate a connection with the Quick Auth Server: <link rel="preconnect" href="https://auth.farcaster.xyz />
...
This is a convenience function that makes it easy to make authenticated requests but using it is not a requirement. Use getToken: https://miniapps.farcaster.xyz/docs/sdk/quick-auth/get-token to get a token directly and attach it to requests using the library and format of your choosing.
...
addMiniApp: Prompts the user to add the app: A user discovers an app from their social feed, adds it, and then sees it from their apps screen
...
composeCast: Open the cast composer with a suggested cast. The user will be able to modify the cast before posting it.
...
ready: Hides the Splash Screen. Read the guide on loading your app for best practices: https://miniapps.farcaster.xyz/docs/guides/loading
...
openMiniApp: Opens another Mini App, providing a seamless way to navigate between Mini Apps within the Farcaster ecosystem.
...
Referrer Information: When a Mini App is opened using openMiniApp, the target app receives a special location context with referrer information:
...
signIn:
Request a Sign in with Farcaster (SIWF): https://docs.farcaster.xyz/developers/siwf/ credential from the user.
...
acceptAuthAddress
Type: boolean
Whether an Auth Address: https://github.com/farcasterxyz/protocol/discussions/225 signed message is acceptable. Defaults to true for the best user experience. Set to false if your verification method does not support auth addresses.
...
viewProfile: Displays a user's Farcaster profile. Viewing a profile and follow a user from an app.
...
viewCast: Open a specific cast in the Farcaster client. This navigates the user to view the full cast with its replies and reactions.
...
swapToken: Open the swap form with pre-filled tokens. The user will be able to modify the swap before executing the transaction.
...
sendToken: Open the send form with a pre-filled token and recipient. The user will be able to modify the send before executing the transaction.
...
signManifest (Experimental): This is an experimental feature and may change or be removed in future versions.
...
Haptics: Provides haptic feedback to enhance user interactions through physical sensations. The haptics API includes three methods for different types of feedback: impact, notification, and selection
...
Back Navigation: Integrate with a back navigation control provided by the Farcaster client.

Usage: If your application is already using browser-based navigation: https://miniapps.farcaster.xyz/docs/sdk/back#web-navigation-integration , you can integrate in one line with:
await sdk.back.enableWebNavigation;

That's it! When there is a page to go back to a back control: https://miniapps.farcaster.xyz/docs/sdk/back#back-control will be made available to the user.
...
Fall back to the History API in browsers where Navigation is not supported: https://developer.mozilla.org/en-US/docs/Web/API/Navigation_API#browser_compatibility ; the back button will always be shown.
await sdk.back.enableWebNavigation;
...
Ethereum wallet: A user minting an NFT using the Warpcast Wallet.

The SDK exposes an EIP-1193 Ethereum Provider: https://eips.ethereum.org/EIPS/eip-1193 at sdk.wallet.getEthereumProvider. You can interact with this object directly or use it with ecosystem tools like Wagmi: https://wagmi.sh/ or Ethers: https://docs.ethers.org/v6/
...
requiredChains
miniapp.requiredChains is an optional manifest: https://miniapps.farcaster.xyz/docs/guides/publishing#host-a-manifest-file property that contains an array of CAIP-2: https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md identifiers. If the host does not support all of the chains declared here, it will know not to try rendering your Mini App.
...
requiredCapabilities
miniapp.requiredCapabilities is an optional manifest: https://miniapps.farcaster.xyz/docs/guides/publishing#host-a-manifest-file property that contains an array of paths to SDK methods, such as wallet.getEthereumProvider or actions.composeCast. If the host does not support all of the capabilities declared here, it will know not to try rendering your Mini App.
...
isInMiniApp: Determines if the current environment is a Mini App context by analyzing both environment characteristics and communication capabilities.
...
Need to branch during server-side rendering? See the Hybrid & SSR-friendly detection subsection in the Publishing guide: https://miniapps.farcaster.xyz/docs/guides/publishing#hybrid-detection
...
Base App: Below is a list of the main incompatibilities Base App is actively working on fixing. For more information on how mini apps work in Base App, please refer to these docs: https://docs.base.org/mini-apps/quickstart/migrate-existing-apps
...
Using Neynar to build mini apps: https://miniapps.farcaster.xyz/docs/managed-services/neynar
...
# Farcaster Mini Apps — Hazır (BaseMan)

- Kaynak: https://miniapps.farcaster.xyz/ (resmi doküman)
- Son hazırlayan: 2025-11-02

Amaç
- BaseMan’i Farcaster Mini App konteynerinde kararlı çalıştırmak, manifest doğrulamak, embed meta etiketlerini sağlamak, MiniApp SDK ile cüzdan/aksiyonları entegre etmek ve isteğe bağlı Quick Auth doğrulamasını kurmak.

## Temel Kavramlar
- Manifest:`/.well-known/farcaster.json`zorunlu;`accountAssociation`ile domain sahipliği;`miniapp`objesi meta bilgiler ve`requiredChains`(8453, 84532) içerir.
- Embed: HTML`<head>`içinde`<meta name="fc:miniapp" content='{"version":"1", ...}'>`(geriye uyumluluk için`fc:frame`desteklenir).
- SDK:`@farcaster/miniapp-sdk` ile container aksiyonları (`actions/ready`vb.), cüzdan sağlayıcı erişimi (EIP‑1193 semantiği) ve Mini App yaşam döngüsü.
- Quick Auth: Kullanıcı kimlik doğrulaması için Farcaster Quick Auth; JWKS (lokal) veya upstream doğrulama.

Manifest Gereksinimleri (Özet)
-`accountAssociation`: Farcaster hesabı ile domain sahipliğini kanıtlar (payload base64url çözülür, domain eşleşmesi kontrol edilir).
- `miniapp`: `name`, `homeUrl`, `iconUrl`, `screenshotUrls`/`heroImageUrl`, `webhookUrl`, `requiredChains`("eip155:8453","eip155:84532").
- İçerik güvenliği ve uzak bağlantılar için uygun CSP alanları (resim/font/connect src) önerilir.

## Embed Gereksinimleri
- Cast’ta kart/splash geçişi için`<meta name="fc:miniapp" ...>`bulunmalı ve JSON gövdesi serileştirilmiş olmalı.

SDK ve Cüzdan
- Mini App içinde EIP‑1193 sağlayıcıya erişim;`actions/ready`sonrası`eth_accounts`/`eth_requestAccounts`çağrıları.
- Web’de (container dışında) fallback cüzdan akışına izin verilebilir (BaseMan bunu ayrı bundle ile yapıyor).

Quick Auth (Doğrulama Seçenekleri)
- Lokal/JWKS: Farcaster issuer JWKS ile imza doğrulama, domain eşleştirme.
- Upstream:`MINIAPP_AUTH_VERIFY_URL`ile harici doğrulama servisine POST.

Uygulama Kontrol Listesi (Farcaster)
- [ ]`/.well-known/farcaster.json`HTTP 200 ve geçerli JSON dönüyor
- [ ]`accountAssociation.payload`çözüldüğünde domain, host ile eşleşiyor
- [ ]`requiredChains`Base (8453) ve Base Sepolia (84532)
- [ ]`index.html` `<head>`içinde geçerli`fc:miniapp`meta etiketi
- [ ] MiniApp SDK yüklü ve`actions/ready`çağrısı yapılıyor
- [ ] (Opsiyonel) Quick Auth modu ve doğrulama yolu yapılandırıldı

BaseMan Eşleştirmesi
- Manifest dosyası:`.well-known/farcaster.json`- Embed meta etiketi:`index.html`- SDK ve cüzdan:`src/miniapp-auth.js`, `src/mock-miniapp-provider.js`, `vendor/miniapp-sdk/index.min.js`- Quick Auth backend:`api/miniapp-auth.js`, `api/_lib/miniapp-auth-verify.js`## Notlar
- Şema alanlarını uydurmayın; resmi şema ve SDK ile doğrulayın.
- Embed için`fc:miniapp`tercih edin (legacy`fc:frame` yalnızca geriye uyumluluk içindir).
